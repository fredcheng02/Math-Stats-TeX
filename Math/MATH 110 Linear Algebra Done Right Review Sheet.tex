...
\begin{itemize}
    ...
    \end{itemize}
    \item The \textit{dual map} $T' \in \mathcal{L}(W',V')$ of $T \in \LVW$ given by $T'(\phi)=\phi \circ T$ for $\phi \in W'$. We have to be very clear about what this definition means. Here $T'$ maps a function to a function.
    \begin{equation*}
        \begin{tikzcd}
            W \arrow[dd, "\phi"'] &  & V 
    ...
    \item There is a good example (3.104) in the book about annihilators. For the dual basis $\phi_1,\dots,\phi_5$ in $(\F^5)'$ that corresponds to $e_1,\dots,e_5$ in $\F^5$, $(\s(e_1,e_2))^0 = \s(\phi_3,\phi_4,\phi_5)$.
    ...
    \item For FDVS $V$ and its subspace $U$, $$\d U + \d U^0 = \d V.$$ The book mentions two proofs.
\end{itemize}
