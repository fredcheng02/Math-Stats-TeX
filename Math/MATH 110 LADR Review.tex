...
\begin{itemize}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item $V$ has a basis consisting of eigenvectors corresponding to each $\lambda_i$'s;
    ...
    \end{enumerate}
    We consider the whole list of eigenvalues $\lambda_1, \dots, \lambda_n$ with repetition ($n \geq m$).
