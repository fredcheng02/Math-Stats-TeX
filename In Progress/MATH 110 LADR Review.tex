...
\begin{itemize}
    ...
    \item $Se_1,\dots,Se_n$ is orthonormal for every orthonormal list of vectors in $V$;
    ...
    \item If we let $V$ be a complex inner product space, then the above example $S$ is the only type of isometry allowed.
