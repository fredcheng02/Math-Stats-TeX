...
\begin{itemize}
    ...
    \end{enumerate}
    \item The set $\mathcal{M}$ of Möbius transformations from $\widehat{\C}$ to $\widehat{\C}$ forms a group under function composition. This group is isomorphic to the projective general linear group (PGL) and the projective special linear group (PSL) under matrix multiplication.
\end{itemize}
